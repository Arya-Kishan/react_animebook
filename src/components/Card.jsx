...
const Card = ({ obj }) => {
  ...
  return (
    <div onClick={() => handleCardClick(obj.mal_id)} className='w-[100px] h-[130px] sm:w-[250px] flex flex-col gap-2 relative flex-shrink-0 bg-white p-2 text-[15px]'>
      <div className='w-[80px] sm:w-[248px]'><MyImage src={obj.images.webp.image_url} width={"100%"} height={"100%"} /></div>
