    ...
    return (
        <div className='h-[230px] sm:h-[370px] flex flex-col gap-2'>
            ...
            <div className='flex gap-2 rounded-lg overflow-x-scroll p-2'>
                {data && data.map((e) => (<div key={e.mal_id} onClick={() => navigate(`/characterDetails/${e.mal_id}`)} className='flex flex-col gap-2 w-[120px] sm:w-[200px] bg-white p-2 hover:cursor-pointer flex-shrink-0'>
                    <LazyLoadImage
                        alt=""
                        effect="blur"
                        threshold={100}
