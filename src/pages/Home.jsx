...
const Home = () => {
    return (
        <div className='w-full h-dvh flex flex-col md:flex-row relative overflow-hidden'>
            ...
            <div className='md:w-[50%] h-full flex flex-col items-center md:items-start justify-center gap-5 pl-5 md:pl-10 lg:pl-20 z-50'>
                <h1 className='w-[70%] md:w-full text-[25px] md:text-5xl pt-[70px] md:pt-0 text-center md:text-start font-bold uppercase'>Welcome to animebook see the world famous anime</h1>
                <button className='text-2xl font-semibold bg-[#BCAC9C] border-none rounded-md px-3 py-2'>Explore</button>
            </div>
            ...
            <img src={polygon1} className='absolute top-[25%] left-[30%] w-[20px] h-[20px]'></img>
